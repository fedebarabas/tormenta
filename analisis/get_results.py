...
def get_results(filename, shape):
...
chi2 = i3_data_in['i']
fit_sigma = 0.5 * i3_data_in['w']     # 0.5 factor to turn the width of the
n_photons = i3_data_in['a']           # gaussian into a sigma

# LOCALIZATION BINNING
H, xedges, yedges = np.histogram2d(0.001 * y_locs, 0.001 * x_locs,
                                   bins=np.ceil(shape/render_px))
